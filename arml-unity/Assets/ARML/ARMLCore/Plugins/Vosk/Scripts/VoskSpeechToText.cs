...
public class VoskSpeechToText : MonoBehaviour
{
    ...
    public string ModelPathEN = "";
    [Tooltip("Location of the Spanish model, relative to the Streaming Assets folder.")]
    public string ModelPathES = "";
    ...
    [Tooltip("The phrases that will be detected in English. If left empty, all words will be detected.")]
    public List<string> KeyPhrasesEN = new List<string>();
    [Tooltip("The phrases that will be detected in Spanish. If left empty, all words will be detected.")]
    public List<string> KeyPhrasesES = new List<string>();
    ...
    public void StartVoskStt(List<string> keyPhrases = null, string modelPath = default, bool startMicrophone = false, int maxAlternatives = 1, bool changedLanguage = false)
    {
        if (_isInitializing)
        {
    ...
    public void ChangeModel()
    {
        ...
        StartVoskStt(startMicrophone: startRecording, changedLanguage: true);
    }
}