...
namespace ARML.DS.Inspectors
{
    ...
    public class DSDialogueInspector : Editor
    {
        ...
        //Default Answers
        private SerializedProperty didNotHearClipEN;
        private SerializedProperty didNotHearClipES;
        private SerializedProperty didNotUnderstandClipEN;
        private SerializedProperty didNotUnderstandClipES;
        ...
        private SerializedProperty OnInteractedEvent;
        ...
        private void OnEnable()
        {
            ...
            didNotHearClipEN = serializedObject.FindProperty(nameof(didNotHearClipEN));
            didNotHearClipES = serializedObject.FindProperty(nameof(didNotHearClipES));
            didNotUnderstandClipEN = serializedObject.FindProperty(nameof(didNotUnderstandClipEN));
            didNotUnderstandClipES = serializedObject.FindProperty(nameof(didNotUnderstandClipES));
            ...
            OnInteractedEvent = serializedObject.FindProperty(nameof(OnInteractedEvent));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            string dialogueFolderPath = $"Assets/ARML/ARMLCore/DialogueSystem/Dialogues/{currentDialogueContainer.FileName}";
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            DSDialogueGroupSO selectedDialogueGroup = DSIOUtility.LoadAsset<DSDialogueGroupSO>($"Assets/ARML/ARMLCore/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
        ...
        private void DrawDefaultAnswersArea()
        {
            ...
            didNotHearClipEN.DrawPropertyField();
            didNotHearClipES.DrawPropertyField();
            didNotUnderstandClipEN.DrawPropertyField();
            didNotUnderstandClipES.DrawPropertyField();
            DSInspectorUtility.DrawSpace();
        }
        ...
        private void DrawUnityEvent()
        {
            ...
            OnInteractedEvent.DrawPropertyField();
        }
