    ...
    public static class DSIOUtility
    {
        ...
        private static void SaveNodeToGraph(DSNode node, DSGraphSaveDataSO graphData)
        {
            ...
            DSNodeSaveData nodeData = new DSNodeSaveData()
            {
                ...
                AudioClipEN = node.AudioClipEN,
                AudioClipES = node.AudioClipES,
                AudioClipCA = node.AudioClipCA,
        ...
        private static List<DSDialogueChoiceData> ConvertNodeChoicesToDialogueChoices(List<DSChoiceSaveData> nodeChoices)
        {
            ...
            foreach (DSChoiceSaveData nodeChoice in nodeChoices)
            {
                ...
                {
                    TextEN = nodeChoice.TextEN,
                    TextES = nodeChoice.TextES,
                    TextCA = nodeChoice.TextCA
                };
        ...
        {
            DSGraphSaveDataSO graphData = LoadAsset<DSGraphSaveDataSO>("Assets/ARML/ARMLCore/DialogueSystem/Editor/Graphs", graphFileName);
            ...
            if (graphData == null)
            {
                EditorUtility.DisplayDialog(
                    ...
                    $"\"Assets/ARML/ARMLCore/DialogueSystem/Editor/Graphs/{graphFileName}\".\n\n" +
        ...
        private static void LoadNodes(List<DSNodeSaveData> nodes)
        {
            foreach (DSNodeSaveData nodeData in nodes)
            {
                ...
                node.TextEN = nodeData.TextEN;
                node.TextES = nodeData.TextES;
                node.TextCA = nodeData.TextCA;
                node.AudioClipEN = nodeData.AudioClipEN;
                node.AudioClipES = nodeData.AudioClipES;
                node.AudioClipCA = nodeData.AudioClipCA;
        ...
        private static List<DSChoiceSaveData> CloneNodeChoices(List<DSChoiceSaveData> nodeChoices)
        {
            ...
            foreach (DSChoiceSaveData choice in nodeChoices)
            {
                DSChoiceSaveData choiceData = new DSChoiceSaveData()
                {
                    ...
                    TextES = choice.TextES,
                    TextCA = choice.TextCA,
